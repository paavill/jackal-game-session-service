...
import ru.rsreu.jackal.game.action_result_handling.initers.in_process.InProcessWithTeleportOnShipHandlerInitializer
...
class BallCell(position: Position) : OnePirateStoringCell(position) {
    ...
    override fun setPirate(pirate: Pirate): CellActionResultHandlerInitializer {
        ...
        return InProcessWithTeleportOnShipHandlerInitializer()
    }
